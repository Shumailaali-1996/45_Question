...
const Your_Name : string = "Hello Abdul Ahad"
console.log(`${Your_Name}, would you like to learn some python today?`);
...
let variabl_name: String = "Abdul Ahad"
console.log(variabl_name.toUpperCase());
console.log(variabl_name.toLowerCase());
console.log(variabl_name.split(""));
...
*/
let Full_name : string = "Ahad";
let message = `${Full_name} u can do it`
console.log(message);``
...
let Fname : string = "\xa0 Abdul Ahad"
console.log(Fname);
